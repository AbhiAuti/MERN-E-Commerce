    ...
    <footer className="flexCenter pb-24 pt-20">
      <div className="max_padd_container flex w-full flex-col gap-14">
        <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
          ...
          <FooterColomn title={col.title} key={col.title}>
      ...
      <div className="border bg-gray-20">
        <p className="text-center regular-14 text-gray-30">2024 shoppea| all right reserved</p>
      </div>
      </div>
    </footer>
  )
};
const FooterColomn=({title,children})=> {
  return(
    <div className="flex flex-col gap-5">
