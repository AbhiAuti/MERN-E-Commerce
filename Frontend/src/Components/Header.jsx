...
const Header = () => {
  ...
  return (
   <header className="fixed top-0 left-0 m-auto max_pad_container w-full bg-white ring-1 ring-slate-900/5 z-10" >
     <div className="px-4 flexBetween py-3 max -xs:px-2">
        
{/* {logo} */}
      <div>
    <Link><img src={logo} alt="" height={66} width={86} /></Link>
      </div>
 {/* Navbar */}
