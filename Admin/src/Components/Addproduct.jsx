...
const Addproduct = () => {
  ...
  return (
    <div className='p-8 box-border bg-white w-full rounded-sm mt-4 lg:m-7'>
      ...
      <div className='mb-3 item-center gap-x-4'>
        <h4 className="bold-18 pb-2">Product Category:</h4>
        <select value={productdetails.category} onChange={changeHandler} name="category" id='' placeholder='Type here' className='bg-primary ring-1 ring-slate-900/20 medium-16 rounded-sm outline-none'>
